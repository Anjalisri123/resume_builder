  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input type="text" placeholder='enter your skills (e.g .. javascipt ,project management)'className='flex-1 px-3 py-2 text-sm'
...
<div className='bg-blue-50 p-3 rounded-lg'>
    ...
    Add 8-12 relevant skills.Include both technical skills(programming language, tools)
