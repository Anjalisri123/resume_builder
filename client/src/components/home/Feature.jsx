...
<Title title="build your powerful resume" description="Our streamline process helps you to create a professional resume in minutes with intelligent AI-powered tools and features."/>

            <div className="flex flex-col md:flex-row items-center xl:-mt-3">
